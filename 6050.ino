...
//
//  Serial.println("start offset values");
...
//  Serial.println("end offset values");
...
//  Serial.println("start calculation");
  ...
  int p= round(angle_pitch_output);
  int r= round(angle_roll_output);
...
//  Serial.println("start read function");   
...
//Serial.println("end read function");
}


void setup_mpu_6050_registers(){
//  Serial.println("start setup register function");
  ...
  Wire.endTransmission();                                              //End the transmission
//  Serial.println("end setup register function");
}
